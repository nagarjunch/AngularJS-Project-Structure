...
!function (t) {
    ...
    e.prototype = {
        _init: function () {
            ...
            var e, n, o, a, r, h = this.$elmt.children(".vegas-slide"), d = this.settings.slides[s].src, l = this.settings.slides[s].video, g = this._options("delay"), u = this._options("align"), c = this._options("valign"), p = this._options("cover"), m = this._options("color") || this.$elmt.css("background-color"), f = this, v = h.length, y = this._options("transition"), _ = this._options("transitionDuration"), w = this._options("animation"), b = this._options("animationDuration");
...
!function (t, i, e, s) {
    ...
    o.prototype.transformSupport = function (t) {
        ...
        for (var e = 0, s = this.$layers.length; s > e; e++) {
            var o = this.depths[e], n = this.$layers[e], a = this.vx * o * (this.invertX ? -1 : 1), r = this.vy * o * (this.invertY ? -1 : 1);
...
!function (e) {
    ...
    e.fn.cycle = function (i) {
        ...
        opts: function () {
            ...
            var n = this.opts();
            if (n._initialized) {
                var s = n.API.getSlideOpts(), o = n.slides[n.currSlide];
        ...
        custom: {}, none: {
            ...
            before: function (e, t, i, n) {
                ...
                e.cssBefore = {
                    ...
                    visibility: "visible",
                    display: "block"
                }, e.cssAfter = {zIndex: e - 1, top: 0}, e.animIn = {top: 0}, e.animOut = {top: n ? s : -s}
            }
        }
    }, e.fn.cycle.defaults = {
        allowWrap: !0,
    ...
    function n(t, i, n, s, o) {
        ...
        i.container.animate({height: c}, i.autoHeightSpeed, i.autoHeightEasing)
    }
    ...
    e.extend(e.fn.cycle.defaults, {loader: !1}), e(document).on("cycle-bootstrap", function (t, i) {
        function n(t, n) {
            ...
            var l = [];
            if ("string" == e.type(t)) t = e.trim(t); else if ("array" === e.type(t))for (var r = 0; r < t.length; r++)t[r] = e(t[r])[0];
            t = e(t);
            var a = t.length;
    ...
    function i(e, t) {
        ...
        if (!i.busy || i.manualTrump) {
            var n = e.children().index(t), s = n, o = i.currSlide < s;
    ...
    e.extend(e.fn.cycle.defaults, {
        ...
        if (!t.allowWrap) {
            var s = t.disabledClass, o = t.API.getComponent("next"), c = t.API.getComponent("prev"), l = t._prevBoundry || 0, r = void 0 !== t._nextBoundry ? t._nextBoundry : t.slideCount - 1;
    ...
    e.extend(e.fn.cycle.defaults, {tmplRegex: "{{((.)?.*?)}}"}), e.extend(e.fn.cycle.API, {
        tmpl: function (t, i) {
            var n = new RegExp(i.tmplRegex || e.fn.cycle.defaults.tmplRegex, "g"), s = e.makeArray(arguments);
            return s.shift(), t.replace(n, function (t, i) {
                var n, o, c, l, r = i.split(".");
                for (n = 0; n < s.length; n++)if (c = s[n]) {
                    if (r.length > 1)for (l = c, o = 0; o < r.length; o++)c = l, l = l[r[o]] || i; else l = c[i];
...
var option_overlay_skin = "black", option_overlay_animation = "fade", option_overlay_content_animation = "slide", option_hero_parallax_hover_effect = "on", option_hero_gravity_effect = "on", option_hero_background_mode = "kenburns", option_hero_background_image_path = [{src: "/content/images/1.jpg"}], option_hero_background_slider_path = [{src: "/content/images/1.jpg"}], option_hero_background_slider_delay = 6e3, option_hero_background_slider_transition = "slideDown", option_hero_background_slider_transitionDuration = 800, option_hero_background_kenburns_path = [{src: "/content/images/1.jpg"}], option_hero_background_kenburns_delay = 6e3, option_hero_background_kenburns_transition = "slideDown", option_hero_background_kenburns_transitionDuration = 800, option_hero_background_youtube_url = "https://www.youtube.com/watch?v=kB5xkGZmf_Q", option_hero_background_youtube_startPoint = 0, option_hero_background_youtube_endPoint = 90, option_hero_background_youtube_mute = "on", option_hero_background_youtube_loop = "on", option_hero_background_color_custom_color = "#6e00ff", option_hero_background_gradient_colorArray = new Array([62, 35, 255], [60, 255, 60], [255, 35, 98], [45, 175, 230], [255, 0, 255], [255, 128, 0]), option_hero_background_gradient_stransitionSpeed = 8, option_hero_background_sphere_distance = 300, option_hero_background_sphere_rotation_speed = .2, option_hero_background_sphere_line_color = "#ffffff", option_hero_background_sphere_dot_color = "#ffffff", option_hero_background_sphere_background_color = "#000000", option_hero_background_waves_distance = 1500, option_hero_background_waves_dotSpacing = 120, option_hero_background_waves_dotAmountX = 20, option_hero_background_waves_dotAmountY = 60, option_hero_background_waves_dot_color = "#ffffff", option_hero_background_waves_background_color = "#000000", option_hero_background_mesh_color = "#ffffff", option_hero_background_mesh_background_color = "#111111", option_hero_background_mesh_spotlight_size = 600, option_hero_background_space_star_amount = 512, option_hero_background_space_star_speed = 2.5, option_hero_background_star_star_color = "#ffffff", option_hero_background_star_background_color = "#000000", option_analytics_tracking = "off", option_analytics_tracking_id = "UA-XXXXXXXX-X";
function getUrlParameter(e) {
    var a, o, t = decodeURIComponent(window.location.search.substring(1)), s = t.split("&");
    for (o = 0; o < s.length; o++)if (a = s[o].split("="), a[0] === e)return void 0 === a[1] ? !0 : a[1]
}
function loadtracking() {
    window._gaq.push(["_setAccount", option_analytics_tracking_id]), window._gaq.push(["_trackPageview"]), function () {
...
if (jQuery(window).on("load", function () {
        ...
        setTimeout(function () {
            $("#page-loader").addClass("hide-this"), $("#cycle").cycle("goto", "0"), setTimeout(function () {
                $(".hero .background-content.page-enter-animated").addClass("show"), setTimeout(function () {
                    $(".hero .front-content.page-enter-animated").addClass("show"), blockEvents = !1
                }, 600), $(".social-icons li a").tooltip({container: "body", delay: {show: 150, hide: 0}})
            }, 200)
        }, 600)
        ...
        $(".options-panel .panel-button").click(function () {
            ...
            $("#overlay-content-animation p").removeClass("active"), $(this).addClass("active"), $(this).hasClass("overlay-content-animation-fade") ? ($(".overlay-1,.overlay-2").addClass("edit"), $(".overlay-1,.overlay-2").addClass("fade-In"), $(".overlay-1,.overlay-2").removeClass("slide-from-bottom"), setTimeout(function () {
                    $(".overlay-1,.overlay-2").removeClass("edit")
                }, 10)) : ($(".overlay-1,.overlay-2").addClass("edit"), $(".overlay-1,.overlay-2").removeClass("fade-In"), $(".overlay-1,.overlay-2").addClass("slide-from-bottom"), setTimeout(function () {
                    $(".overlay-1,.overlay-2").removeClass("edit")
                }, 10))
        }), $(".options-panel .gravity-remove-button").click(function () {
            $("#canvas canvas").length && ($("html, body").animate({scrollTop: "0"}), $("#canvas canvas").remove(), $(".options-panel .gravity-remove-button,.options-panel .pei").remove())
...
if ($(document).ready(function () {
        "use strict";
        function e() {
            b.children().css("transition", "all 800ms 200ms"), h.removeClass("overlay-active"), h.addClass("show"), "youtube" === option_hero_background_mode && setTimeout(function () {
                h.find("div.controls").addClass("show")
        ...
        function a() {
            b.children().css("transition", "all 1000ms 500ms"), h.addClass("overlay-active"), h.removeClass("show"), $("#cycle").cycle("pause"), h.find("div.controls").removeClass("show")
        }
        ...
        function r() {
            var e = 0;
            switch (0 == $(".overlay-1").length && 0 == $(".overlay-2").length ? e = 3 : 0 == $(".overlay-1").length ? e = 2 : 0 == $(".overlay-2").length && (e = 1), $(".social-icons li a.go-down").closest(".li").fadeIn(1), e) {
                case 1:
                    v = $(".overlay-1"), C = !0, $(".social-icons li a.go-down").parent().fadeOut(1);
                    break;
                case 2:
                    v = $(".overlay-2"), C = !0;
                    break;
        ...
        function l() {
            if (y === !1 && blockEvents === !1)switch (blockEvents = !0, g) {
                case 1:
                    a(), o(), setTimeout(function () {
                        d.addClass("open"), setTimeout(function () {
                            v.addClass("active"), setTimeout(function () {
                    ...
                    break;
                case 2:
                    0 == C ? (v.removeClass("active"), i(), setTimeout(function () {
        ...
        function c() {
            if (0 == blockEvents)switch (blockEvents = !0, g) {
                case 1:
                    blockEvents = !1;
                    break;
                case 2:
                    v.removeClass("active"), s(), i(), setTimeout(function () {
                        d.removeClass("open"), setTimeout(function () {
                    ...
                    break;
                case 3:
                    u.removeClass("active"), setTimeout(function () {
                        v.addClass("active"), setTimeout(function () {
                            g = 2, blockEvents = !1
                        }, 800)
                    }, 800);
        ...
        var d = $("#overlay"), v = $(".overlay-1"), u = $(".overlay-2"), m = $("#overlay section"), f = $(".go-up"), p = $(".go-down"), h = $("#hero .front-content"), b = $("#hero .front-content .container-mid"), y = !1, C = !1, g = 1;
        switch (r(), $("#hero").hasClass("error-404") || (p.click(function () {
            l()
        }), f.click(function () {
            c()
...
$(document).ready(function () {
    ...
    function i() {
        "on" === option_hero_background_youtube_mute && (option_hero_background_youtube_mute = !0, $(".volume-button").removeClass("fa-volume-up").addClass("fa-volume-off")), "off" === option_hero_background_youtube_mute && (option_hero_background_youtube_mute = !1), "off" === option_hero_background_youtube_loop ? option_hero_background_youtube_loop = !1 : option_hero_background_youtube_loop = !0, $(".hero .bg-video").append('<div id="bg-youtube" class="player showOn-video-bg"></div>'), $(".hero #bg-youtube").attr("data-property", '{videoURL:option_hero_background_youtube_url,containment:".bg-video",autoPlay:true,mute:option_hero_background_youtube_mute,startAt: option_hero_background_youtube_startPoint,stopAt: option_hero_background_youtube_endPoint,loop: option_hero_background_youtube_loop,opacity:1,stopMovieOnBlur:false,showControls:false}'), $(".player").mb_YTPlayer(), $(".hero .controls").addClass("show"), $(".volume-button").click(function () {
    ...
    function a() {
        function t() {
            var t = e[n[0]], s = e[n[1]], r = e[n[2]], h = e[n[3]], c = 1 - o, u = Math.round(c * t[0] + o * s[0]), l = Math.round(c * t[1] + o * s[1]), d = Math.round(c * t[2] + o * s[2]), _ = "rgb(" + u + "," + l + "," + d + ")", p = Math.round(c * r[0] + o * h[0]), g = Math.round(c * r[1] + o * h[1]), v = Math.round(c * r[2] + o * h[2]), m = "rgb(" + p + "," + g + "," + v + ")";
            i.css({background: "-webkit-gradient(linear, left top, right top, from(" + _ + "), to(" + m + "))"}).css({background: "-moz-linear-gradient(left, " + _ + " 0%, " + m + " 100%)"}), o += a, o >= 1 && (o %= 1, n[0] = n[1], n[2] = n[3], n[1] = (n[1] + Math.floor(1 + Math.random() * (e.length - 1))) % e.length, n[3] = (n[3] + Math.floor(1 + Math.random() * (e.length - 1))) % e.length)
        }

        var e = option_hero_background_gradient_colorArray, o = 0, i = $(".bg-color"), n = [0, 1, 2, 3], a = option_hero_background_gradient_stransitionSpeed / 1e4;
    ...
    function s() {
        function t() {
            var t, a;
            t = document.createElement("div"), document.getElementById("canvas").appendChild(t), r = new THREE.PerspectiveCamera(75, u / l, 1, 1e4), r.position.z = option_hero_background_sphere_distance, h = new THREE.Scene, c = new THREE.CanvasRenderer, c.setPixelRatio(window.devicePixelRatio), c.setSize(u, l), t.appendChild(c.domElement), c.setClearColor(option_hero_background_sphere_background_color);
            for (var s = 2 * Math.PI, d = new THREE.SpriteCanvasMaterial({
                color: option_hero_background_sphere_dot_color,
                program: function (t) {
                    t.beginPath(), t.arc(0, 0, .5, 0, s, !0), t.fill()
                }
            }), _ = 0; 1e3 > _; _++)a = new THREE.Sprite(d), a.position.x = 2 * Math.random() - 1, a.position.y = 2 * Math.random() - 1, a.position.z = 2 * Math.random() - 1, a.position.normalize(), a.position.multiplyScalar(10 * Math.random() + 450), a.scale.multiplyScalar(2), h.add(a);
            for (var _ = 0; 300 > _; _++) {
                var p = new THREE.Geometry, g = new THREE.Vector3(2 * Math.random() - 1, 2 * Math.random() - 1, 2 * Math.random() - 1);
                g.normalize(), g.multiplyScalar(450), p.vertices.push(g);
                var v = g.clone();
                v.multiplyScalar(.3 * Math.random() + 1), p.vertices.push(v);
            ...
            document.addEventListener("mousemove", o, !1), document.addEventListener("touchstart", i, !1), document.addEventListener("touchmove", n, !1), window.addEventListener("resize", e, !1)
        }

        function e() {
            var t = $(".hero .level-1").width(), e = $(".hero .level-1").height();
            p = t / 2, g = e / 2, r.aspect = t / e, r.updateProjectionMatrix(), c.setSize(t, e)
        }

        function o(t) {
            d = t.clientX - p, _ = t.clientY - g
        }

        function i(t) {
            t.touches.length > 1 && (t.preventDefault(), d = t.touches[0].pageX - p, _ = t.touches[0].pageY - g)
        }

        function n(t) {
            1 === t.touches.length && (t.preventDefault(), d = t.touches[0].pageX - p, _ = t.touches[0].pageY - g)
        }

        function a() {
            requestAnimationFrame(a), s()
        }

        function s() {
            v && (r.position.x += .05 * (d - r.position.x), r.position.y += .05 * (-_ + 200 - r.position.y), r.lookAt(h.position), h.rotation.y += option_hero_background_sphere_rotation_speed / 100, c.render(h, r))
        }

        $(".hero .background-content .bg-overlay").css("z-index", "2");
        var r, h, c, u = $(".hero .level-1").width(), l = $(".hero .level-1").height(), d = 0, _ = 0, p = window.innerWidth / 2, g = window.innerHeight / 2;
        t(), a();
        var v = !0;
        $(document).scroll(function () {
            v = $(this).scrollTop() > $(window).height() ? !1 : !0
        })
    }

    function r() {
        function t() {
            r = document.createElement("div"), document.getElementById("canvas").appendChild(r), h = new THREE.PerspectiveCamera(75, v / m, 1, 1e4), h.position.z = option_hero_background_waves_distance, c = new THREE.Scene, l = new Array;
            ...
            }), s = 0, f = 0; p > f; f++)for (var y = 0; g > y; y++)d = l[s++] = new THREE.Sprite(a), d.position.x = f * _ - p * _ / 2, d.position.z = y * _ - g * _ / 2, c.add(d);
            u = new THREE.CanvasRenderer, u.setPixelRatio(window.devicePixelRatio), u.setSize(v, m), r.appendChild(u.domElement), u.setClearColor(option_hero_background_waves_background_color), document.addEventListener("mousemove", o, !1), document.addEventListener("touchstart", i, !1), document.addEventListener("touchmove", n, !1), window.addEventListener("resize", e, !1)
        }

        function e() {
            var t = $(".hero .level-1").width(), e = $(".hero .level-1").height();
            x = t / 2, w = e / 2, h.aspect = t / e, h.updateProjectionMatrix(), u.setSize(t, e)
        }

        function o(t) {
            y = t.clientX - x, b = t.clientY - w
        }

        function i(t) {
            1 === t.touches.length && (t.preventDefault(), y = t.touches[0].pageX - x, b = t.touches[0].pageY - w)
        }
        ...
        function s() {
            if (k) {
                h.position.x += .05 * (y - h.position.x), h.position.y += .05 * (-b - h.position.y), h.lookAt(c.position);
                for (var t = 0, e = 0; p > e; e++)for (var o = 0; g > o; o++)d = l[t++], d.position.y = 50 * Math.sin(.3 * (e + f)) + 50 * Math.sin(.5 * (o + f)), d.scale.x = d.scale.y = 4 * (Math.sin(.3 * (e + f)) + 1) + 4 * (Math.sin(.5 * (o + f)) + 1);
                u.render(c, h), f += .1
            }
        }

        $(".hero .background-content .bg-overlay").css("z-index", "2");
        var r, h, c, u, l, d, _ = option_hero_background_waves_dotSpacing, p = option_hero_background_waves_dotAmountX, g = option_hero_background_waves_dotAmountY, v = $(".hero .level-1").width(), m = $(".hero .level-1").height(), f = 0, y = 0, b = 0, x = v / 2, w = m / 2;
        t(), a();
        var k = !0;
        $(document).scroll(function () {
            k = $(this).scrollTop() > $(window).height() ? !1 : !0
        })
    }
    ...
    function h() {
        ...
        function i() {
            u = document.createElement("canvas"), l = u.getContext("2d"), y = {
                x: 0,
                y: 0
            }, k = [], p = 180, g = .25 * p, document.getElementById("canvas").appendChild(u), n(), h()
        }

        function n() {
            d = $(".hero .level-1").width(), _ = $(".hero .level-1").height(), u.width = d, u.height = _, y.x = d / 2, y.y = _ / 2, b = !1, x = 0, w = 0, k.length = 0, M = 0, a(), l.strokeStyle = option_hero_background_mesh_color, l.lineWidth = 2
        }

        function a() {
            for (var o = -p / 2; d + p > o; o += p) {
                x++;
                for (var i = -p / 2; _ + p > i; i += p)o == -p / 2 && w++, k.push(new t({
                    x: ~~(o + e(-g, g)),
                    y: ~~(i + e(-g, g))
                }))
            }
        ...
        function r() {
            l.clearRect(0, 0, d, _), l.beginPath();
            for (var t = 0; x > t; t++)for (var e = 0; w > e; e++)v = k[t * w + e], m = t === x - 1 ? null : k[(t + 1) * w + e], f = e === w - 1 ? null : k[t * w + e + 1], m && (l.moveTo(v.x, v.y), l.lineTo(m.x, m.y)), f && (l.moveTo(v.x, v.y), l.lineTo(f.x, f.y));
            l.stroke(), l.fillStyle = "#000", k.forEach(function (t) {
                l.save(), l.beginPath(), l.translate(t.x, t.y), l.rotate(Math.PI / 4), l.rect(0, 0, 0, 0), l.fill(), l.stroke(), l.restore()
            });
            var o = l.createRadialGradient(y.x, y.y, 0, y.x, y.y, option_hero_background_mesh_spotlight_size);
            o.addColorStop(0, "hsla(0, 0%, 0%, 0)"), o.addColorStop(1, "hsla(0, 0%, 0%, 0.93)"), l.fillStyle = o, l.fillRect(0, 0, d, _)
        }

        function h() {
            requestAnimationFrame(h), s(), r()
        }
        ...
        var u, l, d, _, p, g, v, m, f, y, b, x, w, k, M;
        ...
        }, window.addEventListener("resize", n), window.addEventListener("mousemove", c), i(), $(".hero .background-content #canvas canvas").css("background-color", option_hero_background_mesh_background_color)
    }
        ...
        !function (t, e, o, i) {
            ...
            !function () {
                ...
                e.requestAnimationFrame || (e.requestAnimationFrame = function (o, i) {
                    var n = (new Date).getTime(), a = Math.max(0, 16 - (n - t)), s = e.setTimeout(function () {
                        o(n + a)
                    }, a);
                    return t = n + a, s
                ...
                defaults: {
                    ...
                    var t = this.star, e = this.context.canvas.width, o = this.context.canvas.height;
                    this.w = this.$el.width(), this.h = this.$el.height(), this.x = Math.round(this.w / 2), this.y = Math.round(this.h / 2);
                    var i = this.w / e, n = this.h / o;
                    ...
                    var a = function () {
                        s.w = s.$el.width(), s.h = s.$el.height(), s.initW = s.w, s.initH = s.h, s.portrait = s.w < s.h, s.wrapper = t("<canvas />").addClass(s.settings.divclass), s.wrapper.appendTo(s.el), s.starz = t("canvas", s.el), s.starz[0].getContext && (s.context = s.starz[0].getContext("2d"), c = !0), s.context.canvas.width = s.w, s.context.canvas.height = s.h
                    };
                    a();
                    var r = function () {
                        if (c) {
                    ...
                    function t(t) {
                        if (null !== t.beta && null !== t.gamma) {
                            var e = t.gamma, o = t.beta;
                            s.portrait || (e = -1 * t.beta, o = t.gamma), s.cursor_x = s.w / 2 + 5 * e, s.cursor_y = s.h / 2 + 5 * o
                        }
                    }

                    function i(t) {
                        s.cursor_x = t.pageX || t.clientX + n.scrollLeft - n.clientLeft, s.cursor_y = t.pageY || t.clientY + n.scrollTop - n.clientTop
                    }
    ...
    function u() {
        "on" === option_hero_gravity_effect && d()
    }
    ...
    function d() {
        function t(t, e) {
            function o() {
                this.x = Math.random() * t.width, this.y = Math.random() * t.height, this.vx = l.velocity - .5 * Math.random(), this.vy = l.velocity - .5 * Math.random(), this.radius = Math.random() * l.star.width
            }

            var i = 14e3, n = .2, a = $(".hero .level-1").width(), s = $(".hero .level-1").height(), r = Math.round(s * a / i), h = $(t), c = t.getContext("2d"), u = {
                star: {
                    color: "rgba(255, 255, 255, .65)",
                    width: 1
                },
                line: {color: "rgba(255, 255, 255, .65)", width: .2},
                position: {x: 0, y: 0},
                width: a,
                height: s,
                velocity: n,
            ...
            o.prototype = {
                create: function () {
                    ...
                    var t, e, o, i, n = l.length;
                    for (o = 0; n > o; o++)for (i = 0; n > i; i++)t = l.stars[o], e = l.stars[i], t.x - e.x < l.distance && t.y - e.y < l.distance && t.x - e.x > -l.distance && t.y - e.y > -l.distance && t.x - l.position.x < l.radius && t.y - l.position.y < l.radius && t.x - l.position.x > -l.radius && t.y - l.position.y > -l.radius && (c.beginPath(), c.moveTo(t.x, t.y), c.lineTo(e.x, e.y), c.stroke(), c.closePath())
                }
            }, this.createStars = function () {
                var e, i, n = l.length;
                for (c.clearRect(0, 0, t.width, t.height), i = 0; n > i; i++)l.stars.push(new o), e = l.stars[i], e.create();
                e.line(), e.animate(), l.stars.splice(n, n)
            }, this.setCanvas = function () {
                t.width = l.width, t.height = l.height, c.fillStyle = l.star.color, c.strokeStyle = l.line.color, c.lineWidth = l.line.width, e && e.hasOwnProperty("position") || (l.position = {
                    x: .5 * t.width,
                    y: .5 * t.height
                })
                ...
                $(window).on("mousemove", function (t) {
                    l.position.x = t.pageX - h.offset().left, l.position.y = t.pageY - h.offset().top
                })
            }, this.init = function () {
    ...
    if ("on" == option_hero_parallax_hover_effect) {
        var _ = $(".hero").parallax({scalarX: 24, scalarY: 15, frictionX: .1, frictionY: .1});
        $(".hero").hover(function () {
            _.parallax("enable")
        }, function () {
            _.parallax("disable")
    ...
    var p = 800, g = 6e3;
    "slider" === option_hero_background_mode && (p = option_hero_background_slider_transitionDuration, g = option_hero_background_slider_delay), "kenburns" === option_hero_background_mode && (p = option_hero_background_kenburns_transitionDuration, g = option_hero_background_kenburns_delay), $("#cycle").cycle({
        fx: "scrollVert",
        timeout: g,
        delay: 0,
        speed: p,
